...
import type { CollectionItem } from 'chakra3';
import { Select as ChakraSelect, Portal } from 'chakra3';
...
export const SelectItem = forwardRef<HTMLDivElement, ChakraSelect.ItemProps>(function SelectItem(
	props,
	ref
) {
...
export const SelectRoot = forwardRef<HTMLDivElement, ChakraSelect.RootProps>(function SelectRoot(
	props,
	ref
) {
	return (
