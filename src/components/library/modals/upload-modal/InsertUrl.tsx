...
const InsertUrl = ({ handleSelect }: { handleSelect: any }) => {
	...
	const ImageContainer = (
		<Center flex={1}>
			<Center h='300px' w='400px' gap={1} bg='gray.300' flexDir='column'>
				<Image src={url} alt='Preview' objectFit='contain' />
			</Center>
		</Center>
	);
	const body = url ? (
		...
		<Center flex={1} gap={1} color='gray.400' flexDir='column'>
	...
	return (
		<Column gap={2} flex={1} h='full'>
			<Flex>
				<FormControl>
					<Flex gap={2} align='center'>
						<FormLabel fontWeight='bold' m='0' fontSize='14px' whiteSpace='nowrap'>
							Paste an image URL here:
						</FormLabel>
						<Input focusBorderColor={borderColor} size='xs' value={url} onChange={handleChange} />
					</Flex>
				</FormControl>
			</Flex>
