...
import { NavbarDropdown, NavbarWrapper, NavItems, NavItemsWrapper } from './components/index';
...
const PulseNavbar2: FC<NavbarProps> = ({ data, path, content, basic, dataModel, ...props }) => {
