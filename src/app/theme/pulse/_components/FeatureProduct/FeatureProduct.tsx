...
const FeatureProduct: FC<HomeContentProps> = ({ dataModel, content, path, data, basic }) => {
...
const Title = ({ children, css, ...props }: TextProps & { children: any; css: any }) => (
	<Heading
		fontSize={{
...
const SubTitle = ({ children, css, ...props }: TextProps & { children: any; css: any }) => (
	<NormalText
		fontSize={{
